...
- [Contratos de Desarrollo](./contracts/)
  ...
  - [MCP: tools de edicion de slides/deck](./contracts/mcp-showme-slide-tools.md)
  - [MCP: tools de gestion de proyecto completo](./contracts/mcp-showme-project-management-tools.md)
  - [MCP: tools de generacion con IA](./contracts/mcp-showme-ai-tools.md)
